...
for img_name in os.listdir(folder_path):
    ...
    # Resize the image to 299x299 for Xception
...
# Percentage of correct 'Granny Smith' predictions with just pretrained model (no transfer learning): 27.13%
