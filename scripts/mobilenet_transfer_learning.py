...
model_path = f'models/mobilenet_{epochs}_epochs.h5'
results_path = f"plots/mobilenet_{epochs}_epochs/cross_validation"
...
plot_training_history(transfer_history, results_path, 'mobilenet')
